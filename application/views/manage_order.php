                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
							...
							$isstatus = $this->session->userdata('status');
							 ...
							 ?>
                             <span style="float:right;"><a href="<?php echo base_url()?>vendor/add_entry" class="fancybox fancybox.ajax">Entry of Sample Submission</a></span>
                             <?php } ?>
                        </div>
                        <div class="panel-body">
							<div class="form-group" style="width:100%; float:left;">
                                ...
                                <div class="col-md-2" style="padding-right: 0px;">
      										<select class="form-control" id="sldendor" name="vendor">
                                            	<option value="" selected>Select Vendor</option>
                                                  <?php 
												$query_vendor ="select tr_item_ifno.*,tr_company.* from tr_item_ifno Left Join tr_company ON tr_company.vendor_id=tr_item_ifno.vendor Group By tr_item_ifno.vendor Order By tr_item_ifno.item_id Asc";
                                ...
                                <div class="col-md-2" style="padding-right: 0px;">
      										<select class="form-control" id="slmethod" name="method">
                                            	<option value="" selected>...Select One....</option>
                                                <?php 
												$query_method ="select method from tr_item_ifno Group By method Order By sending_date Asc";
												$result_method = mysql_query($query_method)or die(mysql_error());
												while($row_method = mysql_fetch_array( $result_method)){
												?>
                                                <option value="<?php echo $row_method['method']; ?>"><?php echo $row_method['method']; ?></option>
                                                <?php } ?>
                                            </select>
                                </div>
                             <div class="col-md-2" style="padding-right: 0px;">
							...
							?>
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									if($isstatus=="3"){
										$statement2 = "Where tr_item_ifno.create_to='".$isuser."'";
										}
									if($isstatus=="999"){
										$statement2 = "";
										}
									...
									?>
										...
										?>
                                         ...
                                         <?php } ?>
                                            ...
                                            <td><?php if($role=="0"){?><a class="btn btn-primary fancybox fancybox.ajax"  href="<?php echo base_url()?>vendor/update_entry?ID=<?php echo $row['item_id'];?>"><i class="fa fa-edit "></i> Edit</a> &nbsp;<a class="btn btn-danger" onclick="deleteitem(<?php echo $row['item_id'];?>);"><i class="fa fa-pencil"></i> Delete</a> <?php } if(($role=="byer") && ($astatus=="0")){ ?> <a class="btn btn-primary fancybox fancybox.ajax"  href="<?php echo base_url()?>vendor/update_entry?ID=<?php echo $row['item_id'];?>"><i class="fa fa-edit "></i> Comments</a><?php } ?> &nbsp;<a class="btn btn-primary fancyboxview fancybox.ajax"  href="view_order?ID=<?php echo $row['item_id'];?>"><i class="fa fa-eye"></i> View</a></td>
										...
										?>
                                         ...
                                         <?php } ?>
											...
											?>
                                            <td><a class="btn btn-primary fancybox fancybox.ajax"  href="view_order?ID=<?php echo $row['item_id'];?>"><i class="fa fa-eye"></i> View</a></td>
											<?php  }
											}else{
											?>
							...
							?>
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php 
									$i=1;
									$query2 ="select tr_item_ifno.*,tr_company.* from tr_item_ifno Left Join tr_company ON tr_company.vendor_id=tr_item_ifno.vendor Order By tr_item_ifno.item_id Desc";
									$result = mysql_query($query2)or die(mysql_error());
									while($row = mysql_fetch_array( $result )){
										$i++;
								if((!empty($row['sending_date'])) && ($role=="byer")){
									...
									?>
										...
										?>
                                         ...
                                         <?php } ?>
											...
											?></td>
                                            <td><?php echo "ASDr".$row['style_no'];?></td>
                                            <td><?php echo $row['color'];?></td>
                                            <td><?php echo $row['method'];?></td>
                                            <td><?php echo $row['fabirc'];?></td>
                                            <td> <?php if($role=="0"){?><a class="btn btn-primary fancybox fancybox.ajax"  href="<?php echo base_url()?>vendor/update_entry?ID=<?php echo $row['item_id'];?>"><i class="fa fa-edit "></i> Edit</a> &nbsp;<a class="btn btn-danger" onclick="deleteitem(<?php echo $row['item_id'];?>);"><i class="fa fa-pencil"></i> Delete</a> <?php } if(($role=="byer") && ($astatus=="0")){ ?> <a class="btn btn-primary fancybox fancybox.ajax"  href="<?php echo base_url()?>vendor/update_entry?ID=<?php echo $row['item_id'];?>"><i class="fa fa-edit "></i> Comments</a><?php } ?> &nbsp;<a class="btn btn-primary fancyboxview fancybox.ajax"  href="view_order?ID=<?php echo $row['item_id'];?>"><i class="fa fa-eye"></i> View</a></td>
										...
										?>
                                         ...
                                         <?php } ?>
                                            ...
                                            <td><?php echo $row['method'];?></td>
                                            <td><?php echo $row['fabirc'];?></td>
                                            <td><?php if($role=="assist"){?><a class="btn btn-primary fancybox fancybox.ajax"  href="<?php echo base_url()?>vendor/update_entry?ID=<?php echo $row['item_id'];?>"><i class="fa fa-edit "></i> Edit</a><?php } ?> &nbsp;<a class="btn btn-primary fancyboxview fancybox.ajax"  href="view_order?ID=<?php echo $row['item_id'];?>"><i class="fa fa-eye"></i> View</a></td>
                                        </tr>
										<?php  }  
										} ?>
                             ...
                             <?php } 
							 else if(($role!="0") && ($role!="byer") && ($role!="assist") && ($role!="checker")){
							 ?>
                             <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                       <tr>
									...
									$query2 ="select tr_item_ifno.*,tr_company.* from tr_item_ifno Left Join tr_company ON tr_company.vendor_id=tr_item_ifno.vendor where tr_item_ifno.vendor='$role' AND tr_item_ifno.create_to='".$isuser."' Order By tr_item_ifno.item_id Desc";
									$result = mysql_query($query2)or die(mysql_error());
									while($row = mysql_fetch_array( $result )){
										$i++;
									...
									?>
										...
										?>
                                         ...
                                         <?php } ?>
                                            ...
                                            <td><?php echo $row['method'];?></td>
                                            <td><?php echo $row['fabirc'];?></td>
                                            <td> <?php if((empty($row['sending_date'])) && ($role!="0") && ($role!="byer")){?><a class="btn btn-primary fancybox fancybox.ajax"  href="<?php echo base_url()?>vendor/update_entry?ID=<?php echo $row['item_id'];?>"><i class="fa fa-edit "></i> Edit</a><?php } if($role=="0"){?><a class="btn btn-primary fancybox fancybox.ajax"  href="<?php echo base_url()?>vendor/update_entry?ID=<?php echo $row['item_id'];?>"><i class="fa fa-edit "></i> Edit</a> &nbsp;<a class="btn btn-danger" onclick="deleteitem(<?php echo $row['item_id'];?>);"><i class="fa fa-pencil"></i> Delete</a> <?php } if(($role=="byer") && ($astatus=="0")){ ?> <a class="btn btn-primary fancybox fancybox.ajax"  href="<?php echo base_url()?>vendor/update_entry?ID=<?php echo $row['item_id'];?>"><i class="fa fa-edit "></i> Comments</a><?php } ?> &nbsp;<a class="btn btn-primary fancyboxview fancybox.ajax"  href="view_order?ID=<?php echo $row['item_id'];?>"><i class="fa fa-eye"></i> View</a></td>
                                        </tr>
                                        <?php } ?>
...
/*$('input#slstyle').on('input',function(e){*/
	//alert('Changed!')
/*$("#slstyle" ).change(function() {*/
...
<?php if(($role=="0") || ($role=="byer") || ($role=="checker")|| ($role=="assist")){?>
	...
	<?php } else{?>
	var vendor = <?php echo $role;?>;
	<?php } ?>	var style = $('#slstyle').val();
	var method = $('#slmethod').val();
	var emtdat = $('#emtdat').val();
	var comt = $('#comt').val();
	var submitvendor ="sstyle"
	if(vendor == ""){
		vendor =0;
		}
	if(style == ""){
